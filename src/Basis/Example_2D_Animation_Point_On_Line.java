...
public class Example_2D_Animation_Point_On_Line extends JFrame {
    PaintPanel panel=new PaintPanel();
    
    Example_2D_Animation_Point_On_Line() {
        add(panel);
    }  // Constructor
...
//            if (P.x>=B.x) myTimer.stop();
  ...
  public static void main(String[] args) {
    Example_2D_Animation_Point_On_Line frame =
        new Example_2D_Animation_Point_On_Line();
    frame.setTitle("Game Physics - Example_2D_Animation_Point_On_Line");
